...
A simple, single-page web application that converts real-time speech to text using the browser's Web Speech API, and automatically translates texts to target language using a local Ollama instance running the `gemma3n:e2b` model.
